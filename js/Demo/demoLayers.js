...
addLayer("c", {
        ...
        softcap: new MetaNum(1e100), 
        softcapPower: new MetaNum(0.5), 
        ...
        effect() {
            ...
            waffleBoost: (true == false ? 0 : MetaNum.pow(player[this.layer].points, 0.2)),
        ...
        buyables: {
            ...
            11: {
                ...
                cost(x) { // cost for buying xth buyable, can be an object if there are multiple currencies
                    ...
                    let cost = MetaNum.pow(2, x.pow(1.5))
                    return cost.floor()
                },
                effect(x) { // Effects of owning x of the items, x is a MetaNum
                    let eff = {}
                    if (x.gte(0)) eff.first = MetaNum.pow(25, x.pow(1.1))
                    else eff.first = MetaNum.pow(1/25, x.times(-1).pow(1.1))
                ...
                buy() { 
                    ...
                    player[this.layer].spentOnBuyables = player[this.layer].spentOnBuyables.add(cost) // This is a built-in system that you can use for respeccing but it only works with a single MetaNum value
                },
                buyMax() {}, // You'll have to handle this yourself if you want
                style: {'height':'222px'},
                purchaseLimit: new MetaNum(4),
                sellOne() {
...
addLayer("f", {
    ...
    color: "#FE0102",
    requires() {return new MetaNum(10)}, 
    ...
    //directMult() {return new MetaNum(player.c.otherThingy)},
